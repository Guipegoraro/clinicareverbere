...
function Contact() {
  ...
  function validateAppointment() {
    ...
    if (validated) {
      ...
      window.location.replace('http://localhost:5173/obrigado.html'); /* ADICIONAR O ENDEREÇO NO LOCAL DE LOCALHOST:5173 PARA QUE ELE REDIRECIONE */
    }
  }
    ...
    <section className="contact_section" id="Contact">
      <div className="contact_container">
        ...
        <div className="form_submit_btn">
          <button onClick={() => { console.log('clicked'); validateAppointment() }} >ENVIAR</button>
        </div>
      </div>
    </section>
  )
